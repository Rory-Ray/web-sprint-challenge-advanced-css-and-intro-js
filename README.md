...
Acessibility is how we make sure that a website is usable by people with disabilities, it is important for SEO.

Talk about 3 different things you can do to ensure your website is accessible. 
i.You can use the meta tags to make sure that the website is viewable at certain pixle levels. 
ii. You can use semantic html to make your website more acesssable. 
iii. You can use responsive units instead of pixles.

How would you explain the concept of a variable to someone new to programming? 
A variable is a way to give a function or term a name that you can later use to simplify calling it.

What is the purpose of using functions in code? 
We use functions to define a block of code and execute it whenever we want.
